...
<html lang="en">
  <head>
    ...
    <!-- login page css -->
    <link href="<?php echo base_url("css/sucess-page.css");?>" rel="stylesheet" />
      ...
      <div class="row">
        <div class="span12">
          <div class="errorWrapper">
            <h1 class="pageErrorTitle">Registro exitoso!</h1>
            <!-- Aqui se puede poner un mensaje con respecto al problema que haya ocurrido-->
            <span>Se le enviar&aacute; un correo en cuanto el administrador acepte su solicitud.</span>
            <br />
