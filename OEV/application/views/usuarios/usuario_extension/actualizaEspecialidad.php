                ...
                <div id="accordion" class="ui-accordion ui-widget ui-helper-reset ui-accordion-icons" role="tablist">
                  ...
                  <div>
                    ...
                    <div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" style="height: 31px; " role="tabpanel">
                      ...
                      <div class="span1"><input type="checkbox" name="especialidad[]" class="areaCheckbox" 
                      value="<?php echo $sub->idArea_Conocimiento;?>" 
                       id="<?php echo $sub->idArea_Conocimiento;?>"
                           <?php if($sub->tiene_especialidad>0){ echo 'checked="checked"';}?> /></div>
                      <?php 
                        if($imprimi%2 == 0){
                             $contador++;
                             echo "</div>";    
