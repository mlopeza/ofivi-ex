...
<div id="content" class="span9 section-body">
  ...
  <div id="section-body" class="tabbable">
    ...
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab2" data-toggle="tab">Lista de Contactos</a></li>
    </ul>
            ...
            <div id="accordion1" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-star-empty icon-white"></i> <span class="divider-vertical"></span> Lista de Contactos <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
