            ...
            <div id="accordion4" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-th-large icon-white"></i> <span class="divider-vertical"></span> Agregar/Editar Empresa <span id="ete"></span> <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
                      ...
                      <fieldset>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls ui-widget">
                            <input type="text" id="so" class="informacion-sugerencia input-large focused" />
                          </div>
                        </div>
                      </fieldset>
                    </form>
            ...
            <div id="accordion4" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-th-large icon-white"></i> <span class="divider-vertical"></span> Crear Proyecto <span id="ete"></span> <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
