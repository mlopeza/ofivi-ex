<div id="menu-left" class="span3">
                    <div class="sidebar-nav">
                        <ul class="nav nav-list">
                            <li><a class="current active" data-original-title=""><i class="icon-th-large icon-white"></i><span>Usuario Legal</span></a></li>
							<li class="accordion-menu">
                                ...
                                <div class="accordion-body collapse dropdown" id="collapseOne">
                                    <div class="accordion-inner">
                                        <ul class="nav nav-list">
                                            <li><a href="<?php echo base_url("subirContratoLegal");?>">Subir Contrato Legal</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
