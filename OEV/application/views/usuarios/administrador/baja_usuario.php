                                                    ...
                                                    <div class="accordion-inner paddind">
                                                        <table  class="table table-bordered table-striped pull-left" id="example" >
															...
															<?php foreach($data->result() as $row){ ?>
                                                                ...
                                                                <tr>
                                                                    <td id="username"  value="<?php echo $row->idUsuario; ?>"><?php echo $row->Usuario; ?></td>                                                                    <td id="campus" value=""><?php echo $row->Campus; ?></td>                                                                    <td id="escuela" value=""><?php echo $row->Escuela; ?></td>
