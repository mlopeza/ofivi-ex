                                                        ...
                                                        <table  class="table table-bordered table-striped pull-left" id="example" >
															...
															<?php foreach($data->result() as $row){ ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo evalua_tipo_boton($row->Vista_Administrador,'vista_administrador'); ?></td>
                                                                    <td><?php echo evalua_tipo_boton($row->Vista_Supervisor_Extension,'vista_supervisor_extension'); ?></td>
                                                                    <td><?php echo evalua_tipo_boton($row->Vista_Usuario_Extension,'vista_usuario_extension'); ?></td>
                                                                    <td><?php echo evalua_tipo_boton($row->Vista_Profesor,'vista_profesor'); ?></td>
																	<td><?php echo evalua_tipo_boton($row->Vista_Legal,'vista_legal'); ?></td>
																	<td><?php echo evalua_tipo_boton($row->Vista_Cliente,'vista_cliente'); ?></td>
																	<td>
																		<?php 
