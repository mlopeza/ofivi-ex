...
<div id="content" class="span9 section-body">
  <div id="section-body" class="tabbable">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab1" data-toggle="tab" data-original-title="">Categorías</a></li>
    </ul>
            ...
            <div id="accordion2" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-th-large icon-white"></i> <span class="divider-vertical"></span> Categorías <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
            ...
            <div id="accordion3" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-th-large icon-white"></i> <span class="divider-vertical"></span> Subcategorías <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
            ...
            <div id="accordion4" class="accordion">
              <div class="accordion-group">
                <div class="accordion-heading">
                  ...
                  <i class="icon-th-large icon-white"></i> <span class="divider-vertical"></span>Categoría <span id="EtiquetaGrupo"></span> <i class="icon-chevron-down icon-white pull-right"></i>
                  </a>
                </div>
                    ...
                    <form class="form-vertical">
                      <fieldset>
                        <div class="control-group">
                          <label for="focusedInput" class="control-label">Categoría:</label>
                          <div class="controls">
                ...
                <div class="accordion-body in collapse" id="event10" style="height: auto;">
                  <div class="accordion-inner paddind" style="overflow: auto;">
                    ...
                    <form class="form-vertical">
                      <fieldset>
                        <div class="control-group">
                          <label for="focusedInput" class="control-label">Categoria:</label>
                          <div class="controls">
                            <input disabled type="text" id="empresa-grupo-input" class="informacion-extra input-large focused" />
                          </div>
                        </div>
                        <div class="control-group">
                          <label for="focusedInput" class="control-label">Subcategoria:</label>
