                    ...
                    <div class="sidebar-nav">
                        <ul class="nav nav-list">
							...
							<li class="accordion-menu">
                                <a href="#collapseOne" data-toggle="collapse" class="accordion-toggle"><i class="icon-signal"></i><span>Administración de Usuarios<i class="icon-chevron-down pull-right"></i></span></a>
