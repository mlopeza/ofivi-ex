                      ...
                      <div class="tabbable span12">
                        ...
                        <div style="height:400px;padding-bottom: 9px; border-bottom: 1px solid #ddd;" class="tab-content">
                          <div id="tab0" class="tab-pane active">
                            <textarea id="descripcionUsuario" class="textarea" style="width:98%;height:85%;" placeholder="Descripci&oacute;n ..."></textarea>
                          </div>
                          <div id="tab2" class="tab-pane">
                            <textarea id="descripcionUEV" class="textarea" style="width:98%;height:85%;" placeholder="Descripci&oacute;n ..."></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
