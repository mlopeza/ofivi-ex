...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Mario Adri·n LÛpez Alem·n" >
                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav pull-left bar-root">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#"> Administrador de Extensi√≥n</a></li>
                                <li><a href="#"> Usuario de Extensi√≥n</a></li>
				...
				<!--Inicio de Recuadro de Usuario-->
                    <div class="group-menu nav-collapse"> 
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
								<!--Nombre de Usuario-->
								<!--Igual ser√≠a buena idea poner el Rol Actual del Usuario en Este apartado-->
 ...
 alt="avatar" /></div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-info" href="login.html">Cerrar Sesi√≥n</a>
                                        </div>
