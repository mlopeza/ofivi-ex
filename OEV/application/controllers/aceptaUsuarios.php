...
class AceptaUsuarios extends CI_Controller
{
    public function index()
    {
        ...
        $this->load->view('usuarios/administrador/Scripts/admin-users-util');
    ...
    public function verTodo()
    {
        ...
        $query['data'] = $this->usuariomodel->regresaTodo();
        //Manda los datos al header
        $this->load->view('usuarios/header', $vista);
        $this->load->view('usuarios/administrador/menu_administrador');
        $this->load->view('usuarios/administrador/verUsuarios', $query);
        $this->load->view('usuarios/footer');
        $this->load->view('usuarios/administrador/Scripts/admin-users-util2');
    }
    public function insertData()
    {
        ...
        if ($this->form_validation->run('administrador_acepta_usuario') == FALSE) {
            ...
            $mensaje = array(
                'response' => 'true',
                'mensaje' => 'La actualizacion se realizó correctamente.'
            );
