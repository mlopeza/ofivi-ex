...
class DBConnection{
	function getConnection(){
	  //change to your database server/user name/password
		mysql_connect("localhost","root","kopoyeba") or
         die("Could not connect: " . mysql_error());
    //change to your database name
		mysql_select_db("sevi") or 
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="../css/calendar/dp.css" rel="stylesheet" />    
    <link href="../css/calendar/dropdown.css" rel="stylesheet" />    
    <link href="../css/calendar/colorselect.css" rel="stylesheet" />   
     
    <script src="../js/calendar/src/jquery.js" type="text/javascript"></script>    
    <script src="../js/calendar/src/Plugins/Common.js" type="text/javascript"></script>        
    <script src="../js/calendar/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="../js/calendar/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    <script src="../js/calendar/src/Plugins/datepicker_lang_ES.js" type="text/javascript"></script>        
    <script src="../js/calendar/src/Plugins/jquery.datepicker.js" type="text/javascript"></script>     
    <script src="../js/calendar/src/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="../js/calendar/src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
    ...
    .calpick     {        
        ...
        border:none;        
        cursor:pointer;        
        background:url("../css/calendar/sample-css/cal.gif") no-repeat center 2px;        
        margin-left:-22px;    
    }      
    </style>
  </head>
    ...
    <div>      
      <div class="toolBotton">           
        <a id="Savebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Save"  title="Guardar evento.">Guardar</span>          
        </a>                           
        <?php if(isset($event)){ ?>
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">                    
          <span class="Delete" title="Cancelar evento.">Eliminar</span>                
        </a>             
        <?php } ?>            
        <a id="Closebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Close" title="Cerrar ventana." >Cerrar
          </span></a>            
        </a>        
      </div>                  
      ...
      <div class="infocontainer">            
        <form action="/OEV/calendarPHP/datafeed.php?method=adddetails<?php echo isset($event)?"&id=".$event->Id:""; ?>" class="fform" id="fmEdit" method="post">                 
          ...
          <label>                    
            ...
            <div>  
              ...
              <label class="checkp"> 
                <input id="IsAllDayEvent" name="IsAllDayEvent" type="checkbox" value="1" <?php if(isset($event)&&$event->IsAllDayEvent!=0) {echo "checked";} ?>/>          Evento de todo el dia.                      
              </label>                    
            </div>                
          </label>                 
          <label>                    
